...
import { isId, isPassword, isNickname, isEmail } from "../utils/regExLogin";
        ...
        <LoginModal>
          ...
          <LoginForm>
            ...
            <p
              ...
              style={{ textAlign: "center", fontSize: "1em", color: "gray" }}
            >
              회원가입
            </p>
          </LoginForm>
      ...
      <>
        ...
        <JoinModal>
          ...
          <JoinForm>
            ...
            />
            {checkId !== "" && isId(checkId) ? (
              dispatch()
            ) : (
              <div color="red">
                6~12자, 영문을 포함하고 숫자와 일부 특수문자(._-) 입력 가능
              </div>
            )}
            <input
              type="text"
